      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td valign="middle" class="intro bg_white" style="padding: 2em 0 4em 0;">
            <table>
            	<tr>
                    ...
                    <p style="display:flex; font-size: 18px;">Location: <span style="color: #555555">${ticket.address}</span></p>
                    <p><image style="display: block; margin-left: auto; margin-right: auto" src='https://res.cloudinary.com/dwtc6zep7/image/upload/v1606161772/code_q2m7y9.jpg' title="Image" width="200"></image></p>
                    <p>Paid online with TicketApp.</p>
            			</div>
            		</td>
            	</tr>
            </table>
        ...
        <tr>
          <td class="primary email-section" style="padding: 0; width: 100%;">
            <p style='text-align: center; color: #fff; font-size: 18px;'>Present This Barre Code</p>
          </td>
      </tr><!-- end: tr -->
      </table>
    </td>
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td valign="middle" class="bg_white footer">
            <table>
                ...
                <td valign="middle" width="60%" style="padding-top: 20px; text-align: left;">
                	<h3 class="heading">Stay Updated On TicketApp</h3>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td class="bg_light" style="text-align: center;">
          	<p>Email from <a href="https://guarded-tor-38601.herokuapp.com">TicketApp.com</a></p>
          </td>
        </tr>
      </table>
    </div>
